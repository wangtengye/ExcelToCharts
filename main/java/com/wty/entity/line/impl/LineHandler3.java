...
@Component
public class LineHandler3 implements LineHandler {
    @Override
    public String getJson() {
        ...
        for (int i = 1; i < data.size(); i++) {
            ...
            line.setData(temp);
            line.markPoint(new MarkPoint().data(new Data("max"),new Data("min")));
            line.markLine(new MarkLine().data(new Data("average")));
            lines.add(line);
        }
        option.series(lines);
